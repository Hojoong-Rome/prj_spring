                    ...
                    <tr class="text-gray-700 dark:text-gray-400">
                      <td class="px-4 py-3">
                        <div class="flex items-center text-sm">
                          ...
                          <div>
                            <p class="font-semibold"><c:out value="${list.seq}"></c:out></p>
              ...
              <div class="w-full overflow-x-auto" id="updateFormDiv">
                    <form name="form" method="post">
						<div class="input-group">
							<input type="text" name="seq" value="<c:out value='${item.seq }'></c:out>" id="seq" class="form-control bg-light border-0 small" aria-label="seqInput" placeholder="seq">
							<input type="text" name="name" value="<c:out value='${item.name }'></c:out>" id="name" class="form-control bg-light border-0 small" aria-label="nameInput" placeholder="name">
