...
<link
	...
	rel="stylesheet" />
<link rel="stylesheet"
	href="../../../../resources/adminsource/assets/css/tailwind.output.css" />
<script
					...
					<div
						...
						<form name="form" method="post">
							<label class="block text-sm"> <span
								class="text-gray-700 dark:text-gray-400">seq</span> <input
								type="text" name="seq"
								value="<c:out value='${item.seq }'></c:out>" id="seq"
								class="form-control bg-light border-gray-600 small block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
								aria-label="seqInput" readonly>

							</label> <label class="block text-sm"> <span
								class="text-gray-700 dark:text-gray-400">name</span> <input
								type="text" name="name"
								value="<c:out value='${item.name }'></c:out>" id="name"
								class="form-control bg-light border-gray-600 small block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
								aria-label="nameInput">

							</label>
							<button type="button"
								class="px-4 py-2 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-purple-600 border border-gray-700 rounded-lg active:bg-purple-600 hover:bg-purple-700 focus:outline-none focus:shadow-outline-purple"
								id="btnUpdt">Update</button>
							<button type="button"
								class="px-4 py-2 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-purple-600 border-700 border-gray rounded-lg active:bg-purple-600 hover:bg-purple-700 focus:outline-none focus:shadow-outline-purple"
								id="btnDel">Delete</button>
